  ...
  return (
    ...
    >
      <div className={cn(
          ...
          isScrolled 
            ? "bg-card/80 border-border shadow-black/20" 
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <motion.div
                  layoutId="lamp"
                  className="absolute inset-0 w-full rounded-full -z-10 bg-accent/5"
                  initial={false}
                  transition={{
                    type: "spring",
                    stiffness: 300,
                ...
                >
                  <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-8 h-1 rounded-t-full transition-colors duration-300 bg-accent">
                    <div className="absolute w-12 h-6 rounded-full blur-md -top-2 -left-2 transition-colors duration-300 bg-accent/20" />
                    <div className="absolute w-8 h-6 rounded-full blur-md -top-1 transition-colors duration-300 bg-accent/20" />
                    <div className="absolute w-4 h-4 rounded-full blur-sm top-0 left-2 transition-colors duration-300 bg-accent/20" />
                  </div>
                </motion.div>
              )}
            </a>
