              ...
              <div className="relative">
                  ...
                  >
                      <img 
                        ...
                        alt="Momentum Digital team collaborating on a small business web design strategy"
                        loading="lazy"
                        decoding="async"
                      />
                      ...
                      <div className="flex flex-wrap gap-12">
                          ...
                          >
                              <div className="relative w-16 h-16 rounded-full overflow-hidden border-2 border-white/10 group-hover:border-accent transition-colors shadow-xl">
                                  <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&auto=format" className="w-full h-full object-cover" alt="Rahul - Development Lead at Momentum Digital" loading="lazy" />
                              </div>
                              <div>
                          ...
                          >
                              <div className="relative w-16 h-16 rounded-full overflow-hidden border-2 border-white/10 group-hover:border-primary transition-colors shadow-xl">
                                  <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop&auto=format" className="w-full h-full object-cover" alt="Kavita - Design Lead at Momentum Digital" loading="lazy" />
                              </div>
                              <div>
